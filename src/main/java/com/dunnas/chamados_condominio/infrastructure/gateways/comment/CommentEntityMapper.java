...
public class CommentEntityMapper {
    CommentEntity toEntity(Comment comment) {
        CommentEntity commentEntity = new CommentEntity(comment.getContent(), comment.getCallId(), comment.getUserId());
    ...
    Comment toDomainObj(CommentEntity commentEntity) {
        Comment commentDomainObj = new Comment(commentEntity.getContent(), commentEntity.getCallId(), commentEntity.getUserId());
